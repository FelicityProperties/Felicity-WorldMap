...
<title>${escapeHtml(ticker)} Intelligence Brief — Felicity Intelligence</title>
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .brief { white-space: pre-wrap; background: #f0f9ff; border-left: 4px solid #00d4ff; padding: 16px 20px; border-radius: 4px; font-size: 14px; line-height: 1.7; color: #333; margin-top: 8px; }
...
<div class="header">
  <div class="header-left">
    ...
    <div class="sector">${escapeHtml(company.sector)} · ${escapeHtml(company.subIndustry)} · ${escapeHtml(company.hq)}</div>
  </div>
...
<div class="brief">${escapeHtml(briefText)}</div>` : ''}
